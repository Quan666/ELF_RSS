...
建议先阅读 go-cqhttp 使用方法

```bash
https://ishkong.github.io/go-cqhttp-docs/guide/quick_start.html
```
...
移步  [迁移到 Mirai](https://github.com/Quan666/ELF_RSS/wiki/%E8%BF%81%E7%A7%BB%E5%88%B0-mirai)
